...
//HELMET
_Helmet = "";
_HelmetArr = ["sfp_m90d_cap_peltor","lxWS_H_CapB_rvs_blk_ION","VSM_Bowman_cap_Black","VSM_Black_OPS","VSM_Black_OPS_2","VSM_Bowman_cap_Tan","VSM_oga_OPS","VSM_oga_OPS_2","VSM_Tan_spray_OPS","VSM_Tan_spray_OPS_2","rhsusf_opscore_paint_pelt","rhsusf_opscore_paint_pelt_nsw_cam","rhsusf_opscore_ut_pelt","rhsusf_opscore_ut_pelt_nsw_cam"];
