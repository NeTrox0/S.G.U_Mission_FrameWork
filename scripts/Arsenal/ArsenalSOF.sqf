...
switch (_role) do {
	...
	default {
		...
		_object addAction ["<t size='1' shadow='1' color='#00ff00'>Sk.sold RB57</t>", {[player,"SOLD2"] execVM "scripts\Loadout\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
