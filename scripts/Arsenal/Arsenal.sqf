...
switch (_role) do {
	...
	case ("GRPC2"): {
		...
		_object addAction ["<t size='1' shadow='1' color='#00ff00'>Stf.C Skarpskytt</t>", {[player,"STFC3"] execVM "scripts\Loadout\getLoadout.sqf"},[],1,false,true,"","_this distance _target < 15"];
	};
	case ("HPIL");
	case ("JPIL"): {	
